...
- Stateful class components holds data and are build using Lifecycle components.
...
- Stateful logic uses state and with certain logics different components can share same state.

5. Describe how to test a React component with React Testing Library.

- Arrange, Act & Assert is the process to test the code with React Testing Library.
